    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
        Crafted with innovation, impact, and intent — these projects go beyond code. From AI-driven apps to full-stack web experiences, each showcases my ability to architect solutions, lead development, and deliver scalable, user-centric results. With live demos and GitHub links, they reflect my adaptability, passion for learning, and hands-on expertise across modern tech stacks.
        </motion.p>
      </div>
