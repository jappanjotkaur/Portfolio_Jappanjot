...
function About() {
  return (
    ...
    >
      ...
      >
        <p className={"sectionSubText text-gray-300"}>Overview</p>
        <h2 className={"sectionHeadText text-white"}>About Me</h2>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <Link
          href="document/JappanjotResume.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
          {/* FIXED: Removed problematic spans, simple button now */}
          <button className="bg-primary hover:bg-tertiary text-white px-7 py-2 rounded-md transition-all duration-300 hover:scale-105">
            Resume
          </button>
        </Link>
      </motion.div>
